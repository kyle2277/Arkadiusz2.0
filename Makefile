...
CLASSES = Account.class AccountVault.class CharacterList.class CharacterNode.class EncoderDecoder.class

#variable for flags
#-g compiles with debugging information
#-cp defines classpath

JFLAGS = -g -cp ejml/ejml-simple-0.37.1.jar:ejml/ejml-core-0.37.1.jar:ejml/ejml-ddense-0.37.1.jar:commons-lang3-3.8.1/commons-lang3-3.8.1.jar.
...
Account.class: Account.java
   $(JCC) $(JFLAGS) EncoderDecoder.class $(CLASSES)
